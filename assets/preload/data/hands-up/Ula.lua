...
idle_xml_name = 'ula idle'
left_xml_name = 'ula left'
down_xml_name = 'ula down'
up_xml_name = 'ula up'
right_xml_name = 'ula right'
...
name_of_character_xml = 'ula'
name_of_character = 'ula'
name_of_notetype = 'Ula Sing'
name_of_notetype2 = 'fgdfhsdh' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'shutup', 'ula shutup', 12, false);
	addAnimationByPrefix(name_of_character, 'angery', 'ula angery', 12, false);
...
if curStep == 248 then
	objectPlayAnimation(name_of_character, 'shutup');
	setProperty(name_of_character .. '.offset.x', idleoffsets[1]);
	setProperty(name_of_character .. '.offset.y', idleoffsets[2]);
end

if curStep == 312 then
	objectPlayAnimation(name_of_character, 'angery');
	setProperty(name_of_character .. '.offset.x', idleoffsets[1]);
	setProperty(name_of_character .. '.offset.y', idleoffsets[2]);
end
